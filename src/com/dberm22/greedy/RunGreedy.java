...
public class RunGreedy implements EvalFunction
{
  ...
  public static void main(String args[])
  {
    ...
    JFrame mainFrame = new JFrame("GreedyMatch Tester");
    ...
    RunGreedy eval = new RunGreedy();
	HashMap<Integer, Integer> permMap = GreedySearch.greedySearch(u_elements, v_elements, eval);
